...
var _MobileManu = __webpack_require__(4);

var _MobileManu2 = _interopRequireDefault(_MobileManu);
...
var mobileManu = new _MobileManu2.default();
...
var MobileManu = function () {
	function MobileManu() {
		_classCallCheck(this, MobileManu);

		this.manuIcon = (0, _jquery2.default)('.site-header__menue-icon');
		this.manuContent = (0, _jquery2.default)('.site-header__menue-content');
		this.siteHeader = (0, _jquery2.default)('.site-header');
		this.events();
	}

	_createClass(MobileManu, [{
		key: 'events',
...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		value: function events() {
			...
			(0, _jquery2.default)(document).keyup(this.keyPreesHandler.bind(this));
		}
	}, {
		key: 'keyPreesHandler',
		value: function keyPreesHandler(e) {
			if (e.keyCode == 27) {
				this.closeTheModel();
			}
		}
